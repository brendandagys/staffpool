...
from catalog.views import homepage, session_name, code_red_status, code_blue_form, code_pink_form, command_updates
...
urlpatterns = [
    ...
    re_path(r'^.*CommandUpdates.*$', command_updates, name='command_updates'),
